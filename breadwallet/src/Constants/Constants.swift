...
struct C {
    ...
    static let walletQueue = "com.sqoin.bastoji"
    static let null = "(null)"
    static let maxMemoLength = 250
    static let feedbackEmail = "contact@sqoin.com"
    static let iosEmail = "contact@sqoin.com"
   /* static let reviewLink = "https://itunes.apple.com/app/breadwallet-bitcoin-wallet/id885251393?action=write-review"*/
    static let reviewLink = "https://sqoin.us"
