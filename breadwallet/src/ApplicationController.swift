...
class ApplicationController : Subscriber, Trackable {
    ...
    private func initTokenWallets() {
        guard let ethWalletManager = walletManagers[Currencies.btc.code] as? EthWalletManager else { return }
    ...
    private func didInitWalletManager() {
        ...
        if let ethWalletManager = walletManagers[Currencies.btc.code] as? EthWalletManager {
